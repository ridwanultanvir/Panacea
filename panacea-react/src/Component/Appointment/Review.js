...
const getDetails = (props) => {
    ...
    let details = [
        ...
        { header: 'Doctor', value: props.selectedDoctor },
        { header: 'Department', value: props.selectedDepartment },
        { header: 'Schedule', value: schedule.schedule_date + '-' + schedule.start_time + '-' + schedule.end_time },
        { header: 'Problem Description', value: props.problemDescription },
    ];
