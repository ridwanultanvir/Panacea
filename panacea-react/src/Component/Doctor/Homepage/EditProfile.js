...
export default function EditProfile(props) {
    ...
    const [qualification, setQualification] = React.useState(props.userData.qualification);
    ...
    const handleSubmit = () => {
        ...
        let body = {
            ...
            'phoneNumber': phoneNumber, 'doc_qualification': qualification, 'pat_bio': null,
            'emp_education': null, 'emp_training': null
            ...
            >
                ...
                <DialogContent>
                    ...
                    <TextField
                        ...
                        id="standard-basic"
                        label="Qualification"
                        defaultValue={props.userData.qualification}
                        style={{ margin: 2, width: 544 }}
